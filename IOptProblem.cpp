...
// ------------------------------------------------------------------------------------------------
void IOptProblem::SetFunctionMax(double maxPoint, double maxValue)
{
...
// ------------------------------------------------------------------------------------------------
IOptProblem::IOptProblem(int dim, double loBound, double upBound,
  double optPoint, double optVal, int probIndex)
...
// ------------------------------------------------------------------------------------------------
double IOptProblem::GetOptimumPoint() const
{
...
// ------------------------------------------------------------------------------------------------
double IOptProblem::GetMaxPoint() const
{
